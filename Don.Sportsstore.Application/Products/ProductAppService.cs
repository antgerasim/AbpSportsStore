...
{
    //internal class ProductAppService : SportsstoreAppServiceBase, IProductAppService
    internal class ProductAppService : SportsstoreAppServiceBase, IProductAppService
...
/*            var mappedProducts =
        ...
        public async Task<IList<ProductDto>> GetAllProducts() //todo change to listresultDto return type
        {
            var products = await _productRepository
                .GetAll()
